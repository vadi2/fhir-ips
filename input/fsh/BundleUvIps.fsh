...
* entry ^definition = "An entry resource included in the patient summary bundle resource."
* entry ^comment = "Must contain at a minimum the IPS Composition as the first entry and at least one entry each for IPS Problems, Allergies and Medications."
* entry.fullUrl 1.. MS
* entry.search ..0
* entry.request ..0
* entry.response ..0
